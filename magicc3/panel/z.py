...
class mkLogPage(wx.Panel):
	...
	self.gas = gas
	self.logdir = "%s/%s/logs" % (config.datadir, self.gas.lower())
	if not os.path.exists(self.logdir):
		os.makedirs(self.logdir)

	self.currentItem = -1

	box = wx.StaticBox(self, -1, "Operator Log")
...
#	sizer.Add(box1, 0, wx.EXPAND, 0)
#
#	title = wx.StaticText(self, -1, "Date: ")
#	font = title.GetFont()
#	font.SetWeight(wx.BOLD)
#	title.SetFont(font)
#	box1.Add(title, 0, wx.ALIGN_LEFT|wx.TOP, 10)
#
#	self.date = wx.StaticText(self, -1, "")
#	self.date.SetForegroundColour(wx.BLUE)
#	box1.Add(self.date, 0, wx.ALIGN_LEFT|wx.TOP, 10)
#
...
#
#	self.subject = wx.StaticText(self, -1, "")
#	self.subject.SetForegroundColour(wx.BLUE)
#	box2.Add(self.subject, 0, wx.ALIGN_LEFT|wx.TOP, 10)
#
...
#	self.Bind(wx.EVT_LIST_ITEM_RIGHT_CLICK, self.ItemRightClick, listbox)
	...
	config.main_frame.SetStatusText ("Save Log Entry to %s" % file)
	return True
