...
SYSTEM_NAME = "magicc-3"
HOMEDIR    = home                       # Our home
LOGFILE    = HOMEDIR + "/magicc.log"    # log file
ERRORFILE  = HOMEDIR + "/magicc_error.log" # error message file, used for press/flow errors
PFPLOGFILE = HOMEDIR + "/pfp_error.log" # pfp error log file
CONFFILE   = HOMEDIR + "/config/magicc.conf"   # hm configuration file
...
LOGBACKUPDIR = "/logbackup"  # path to partian holding rotating backups of system logs (home dir was set small and was filling up)
...
# list of data files
datafiles = ["data.picarro", "data.aerodyne", "data.sf6", "data.h2", "data.qc", "data.trap_dry_qc",
                "data.picarro.high_freq", "data.aerodyne.high_freq"]
...
transducer_offset = 20
max_transducer_offset = 20
