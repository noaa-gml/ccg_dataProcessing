...
class AxisDialog(wx.Dialog):
	...
	def makeAxisPage(self, nb):
		...
		box1.Add(label, 0, wx.ALIGN_RIGHT|wx.ALL, 0)
		list = ["None", "In", "Out", "In-Out"]
                self.ticType = wx.Choice(page, -1, choices=list)
	...
	def makeLabelsPage(self, nb):
		...
		box.Add(label, 0, wx.ALIGN_CENTRE|wx.ALL, 5)
		list = ["Auto", "Scientific", "Exponential", "Calendar"]
                self.labelFormat = wx.Choice(page, -1, choices=list)
		...
		self.label_font.SetSelectedFont(self.axis.font)
		box1.Add(self.label_font, wx.GROW|wx.ALIGN_RIGHT|wx.ALL)

		label = wx.StaticText(page, -1, "Font Color:")
		box1.Add(label, 0, wx.ALIGN_RIGHT|wx.ALL, 5)
		self.label_color = wx.ColourPickerCtrl(page, -1, self.axis.labelColor)
		box1.Add(self.label_color, 0, wx.ALIGN_LEFT|wx.ALL, 2)
	...
	def makeTitlePage(self, nb):
		...
		self.title_font.SetSelectedFont(self.axis.title.font)
