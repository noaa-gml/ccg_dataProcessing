...
class mkStatusPage(wx.Panel):
    ...
    def getText(self, com):
        ...
        alltxt = ""
        msg =  "**************************************************************************************\n"
        msg += "   CO2 MOLE FRACTIONS REPORTED HERE ARE NOT CORRECTED FOR ISOTOPIC COMPOSITION.\n\n"
        msg += "   THESE RESULTS ARE ISOTOPOLOGUE SPECIFIC MOLE FRACTIONS.  \n"
        msg += "   TOTAL CO2 MOLE FRACTION, DELTA 13C, AND DELTA 18O VALUES ARE REPORTED TO THE DB\n" 
        msg += "**************************************************************************************\n\n"
