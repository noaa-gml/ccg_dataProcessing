...
<HTML>
 ...
 <BODY>
  <FORM action="upload_barcode_ship_file.php" method="POST" enctype="multipart/form-data">
   <?PHP CreateMenu($database_object, $user_obj); ?>
   <TABLE border='1' cellspacing='5' cellpadding='5'>
    <TR>
     <TD colspan='2'>
      <H1>Ship Cylinder from File</H1>
     </TD>
    </TR>
    <TR>
     <TD>
...
<?PHP
   ...
   foreach ( $location_objs as $location_obj )
   {
      ...
      $name = $location_obj->getAbbreviation().' - '.$location_obj->getName();
...
?>
    ...
    <TR>
     ...
     <TD>
      ...
      <A href='example_ship_file.txt'>Example file</A>
     </TD>
    </TR>
    <TR>
     <TD>
     ...
     <TD>
      <INPUT type='text' id='location_comments' name='location_comments' size='40' >
     </TD>
    </TR>
    <TR>
     <TD colspan='2'>
