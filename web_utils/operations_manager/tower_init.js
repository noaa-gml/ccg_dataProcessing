...
//
allow.level = GetAccessLevel(allow.user, allow.tower);
//
...
if (allow.level == 1)
{
	...
	omurl+'om_siteedit.php?proj_name=Tower&proj_abbr=tower', '', defLength, 0, 0);
}
//
...
menu[2][1] = new Item('Tables ...', omurl+'om_tables.php?proj_name=Tower&proj_abbr=tower', '', defLength, 0, 0);
menu[2][2] = new Item('Site Data ...', omurl+'om_sites.php?proj_name=Tower&proj_abbr=tower', '', defLength, 0, 0);
