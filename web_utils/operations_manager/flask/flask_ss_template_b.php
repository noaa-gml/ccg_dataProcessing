<?PHP
# JWM 5/23 - starting a redesign of sample sheets.  This '_b' will be used a a few select sites
# and rolled out if no issues.  Currently controlled by include in the flask_ss_template[n].php files
# Once universal, we can remove the _b and use the same for all.
#  There is also talk of reversing below so we can customize better per language.
# Used on template8 (chinese) initially.
...
$today = date("D M j, Y");
$sq="<IMG src = 'square.gif' height = 25 width = 25>";
    ...
    <FORM NAME='mainform' METHOD=POST>
        ...
        <TABLE width = '100%' align = 'center' cellpadding = 4 border = '0' cellspacing = 2>
            <TR>
                ...
                <TD align='center'>
                    <FONT class='MediumBlackN'>NOAA Global Monitoring Laboratory</FONT><BR>
            ...
            <TR valign = 'top' align='center'>
                <TD align = 'left'>
                    ...
                    <TABLE cellspacing = 2 cellpadding = 2 width='100%' align='center'  border='0'>
                        ...
                        $thirdID
                        <TR><TD></TD></TR>
                        <tr><td align='left' class='SmallBlackB'>PSU # $largepad<br><br><br></td></tr>
                        <tr><td style='border:thin black solid'>
                        <table width='100%'>
                            <!--Time && Date-->
                            <TR>
                                <TD align='center'>
                                <span  class = 'BlackB_warning'>$noteLabel</span><br><br>
                                               <TABLE width='100%' border='0'>
                                                    <TR>
                                                        <TD align='left'>${sq}${sq}${sq}${sq}&nbsp;</TD><!--year-->
                                                        <TD align='left'>${sq}${sq}${sq}&nbsp;</TD><!--month (3)-->
                                                        <TD align='left'>${sq}${sq}&nbsp;</TD><!--day-->
                                                        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>

                                                        <TD align='center'>${sq}${sq}&nbsp;</TD><!--hour-->
                                                        <TD align='left'>${sq}${sq}&nbsp;</TD><!--min-->

                                                    </tr>
                                                    <TR>
                                                        <TD align='left' class = 'SmallBlackB'>$yearLabel</TD>
                                                        <TD align='left' class = 'SmallBlackB'>$monthLabel</TD>
                                                        <TD align='left' class = 'SmallBlackB'>$dayLabel</TD>
                                                        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
...
{#3 rows, we'll attempt to layout similar to physical layout
    $square="<IMG src = 'square.gif' height = 20 width = 20>";
    $html="
    <TABLE frame = 1 cellpadding = 3 cellspacing = 3 width = '100%'>
        ...
        <TR>
            <TD>
                <TABLE width = '100%' border='0' style='border:thin silver solid;'>
                    <tr>
                        <TD colspan='2' align='center' class='SmallBlackB'>SAMPLE MODE</TD>
                        <td colspan='2'></td>
                    </tr>
                    <tr>
                        <TD  colspan='2' align='center'>$square</TD>
                        <td colspan='2'></td>
                    </tr>
                    <TR>
                        <TD colspan='2' align='center' class='SmallBlackB'>DRY MODE</TD>
                        <TD align='center' class='SmallBlackB'>ERROR</TD>
                        <TD align='center' class='SmallBlackB'>CHARGE</TD>
                    </TR>
                    <tr>
                        <TD colspan='2' align='center'>$square</TD>
                    ...
                    <TR>
                        <TD align='center' class='SmallBlackB'>LO BATT</TD>
                        <TD align='center' class='SmallBlackB'>HI TEMP</TD>
                        <TD align='center' class='SmallBlackB'>LEAK</TD>
                        <TD align='center' class='SmallBlackB'>GOOD</TD>
                    </TR>
                    <TR>
                        <TD align='center'>$square</TD>
                        <TD align='center'>$square</TD>
