...
#pages = { 0: 'N2O', 1: 'CO' }
#pages = { 0: 'CO2' }
pages = { 0: 'PC1 CO2', 1: 'PC1 CH4', 2: 'AR1 CO2C13', 3: 'AR1 CO2O18', 4: 'AR1 CO2', 5: 'LGR6 CO2C13', 6: 'LGR6 CO2O18', 7: 'LGR6 CO2' }
    ...
    def doNLPlot(self, gas, current_inst, graph, plottype):
        ...
        for line in resp:
            ...
            if plottype == "Response Curve":
                ...
                rawfile = "/ccg/%s/nl/%s/raw/%s/%s" % (gas.lower(), config.system_name.lower(), yr, file)
                ######################
