...
#        print("axis dmin, dmax", dmin, dmax)
    ...
    def set_date_limits(self, dmin, dmax):
        ...
        if not self.autoscale and not self.set_tics:
            return
...
#        print "self.min, self.max after rounding = ",self.min, self.max
        ...
        self.rrule = rrule(freq,
                           interval=interval,
                           dtstart=num2date(self.min),
                           until=num2date(self.max),
                           bymonth=bymonth,
