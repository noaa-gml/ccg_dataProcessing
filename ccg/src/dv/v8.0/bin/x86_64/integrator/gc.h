...
typedef struct	{
	int	xstart;
	int	xend;
	int	xcrest;			/* bunch at peak max */

	int	xhalfheight_up;		/* bunch at halfheight comming up */
	int	xhalfheight_down;	/* bunch at halfheight going down */

	int	xstartwidth;		/* baseline widths */
	int	xendwidth;

	int	parent_index;		/* -1 if not a rider peak */
