...
;
   ...
   FOR i=0L,n-1 DO BEGIN
      ...
      IF ( KEYWORD_SET(comment) AND nstr GT 26+shift ) THEN BEGIN
         a[i].comment = STRJOIN(str[26+shift:*],' ')
      ENDIF
   ...
   args += ' -stdout -shownames -elevation -intake_height'
   ;
...
;print, tmp
   ...
   ENDIF ELSE BEGIN
      CASE nsp OF
         ...
         ELSE:   BUILD_SITE, data, comment=comment, noprogram=noprogram, tags, arr
      ENDCASE
   ENDELSE
END
