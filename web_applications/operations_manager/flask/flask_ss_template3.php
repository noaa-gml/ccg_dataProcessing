...
$siteLabel="IDENTIFICACI&Oacute;N DE ESTACI&Oacute;N";
#flask
$flaskLabel="MATRAZ N<SUP>o</SUP>";
$pumpLabel="bomba";
$returnLabel="regreso";
...
$dayLabel="D&Iacute;A";
$monthLabel="MES";
$yearLabel="A&Ntilde;O";
$hourLabel="HORA";
$minuteLabel="MINUTO";
$universalTimeLabel="TIEMPO UNIVERSAL (UTC)";
$localStdLabel="HORA EST&Aacute;NDAR LOCAL (LST)";
$daylightSavingsLabel="TIEMPO DE VERANO (DST)";
$noteLabel="USE LA MISMA ZONA HORARIA PARA FECHA Y HORA";#"USE SAME TIME ZONE FOR BOTH DATE & TIME";
...
#wind
$windSpeedLabel="VELOCIDAD DE VIENTO";
$relWindSpeedLabel="VELOCIDAD RELATIVA DE VIENTO";
$metersPerSecLabel="m/s";
$knotsLabel="NUDOS";
$mphLabel="";

$windDirectionLabel="DIRECCIÓN DEL VIENTO";
$relWindDirectionLabel="DIRECCIÓN RELATIVA DEL VIENTO";
$degreeLabel="(GRADOS)";
$obsWindDirectionLabel="OBS. DIRECCIÓN DEL VIENTO";


#Voltage,flow rage & pump pressure
$pad=str_repeat("_",12);#Some translations need this in the middle..
$voltageLabel="VOLTAJE DE BATERIA $pad";
$flowRateLabel="FLUJO DE AIRE $pad";
$pumpPressureLabel="PRESI&Oacute;N DE LA BOMBA $pad";

#Remarks, observer, inventory & contact
$remarksLabel="COMENTARIOS";
$observerLabel="OBSERVADOR";
$inventoryLabel="N<SUP>o</SUP> DE CAJAS DE MATRACES";
$emailLabel="E-MAIL";

#LEDs
$LEDInstructionLabel="MARQUE LAS LUCES QUE EST&Eacute;N ENCENDIDAS CUANDO TERMINE DE TOMAR LA MUESTRA";

#Shipping box
$doNotWriteInThisBoxLabel="NO ESCRIBA EN ESTE CUADRO";
...
echo "<TR>";
echo "<TD align='left' class='SmallBlackB'>IDENTIFICACI&Oacute;N DE ESTACI&Oacute;N</TD>";
...
echo "</TD></TR>";
echo "<TR>";
echo "<TD align='left' class='SmallBlackB'>MATRAZ N<SUP>o</SUP> ${largepad}(bomba)</TD>";
echo "</TR>";
...
echo "<TR>";
echo "<TD align='left' class='SmallBlackB'>MATRAZ N<SUP>o</SUP> ${largepad}(regresso)</TD>";
echo "</TR>";
...
echo "</TD>";
echo "<TR>";
echo "<TD align='center' class = 'SmallBlackB'>D&Iacute;A</TD>";
echo "<TD align='center' class = 'SmallBlackB'>MES</TD>";
echo "<TD align='center' class = 'SmallBlackB'>A&Ntilde;O</TD>";
echo "</TR>";
echo "</TABLE>";
...
echo "<TR>";
echo "<TD align='center' class = 'SmallBlackB'>HORA</TD>";
...
echo "<TD align='left' class = 'LessTinyBlackB'>TIEMPO UNIVERSAL (UTC)</TD>";
echo "</TD>";
echo "</TR>";
echo "<TR>";
echo "<TD align='left'>";
echo "<IMG src = 'circle.gif' height = 10 width = 10></TD>";
echo "<TD align='left' class = 'LessTinyBlackB'>HORA EST&Aacute;DAR LOCAL (LST)</TD>";
echo "</TD>";
echo "</TR>";
echo "<TR>";
echo "<TD align='left'>";
echo "<IMG src = 'circle.gif' height = 10 width = 10></TD>";
echo "<TD align='left' class = 'LessTinyBlackB'>TIEMPO DE VERANO (DST)</TD>";
echo "</TD>";
echo "</TR>";
echo "</TABLE>";
...
echo "<TR>";
echo "<TD align='left' class='SmallBlackB'>VELOCIDAD DE VIENTO ${mediumpad}</TD>";
echo "</TR>";
echo "</TABLE>";
...
echo "<TD align='left'>";
echo "<IMG src = 'circle.gif' height = 10 width = 10></TD>";
echo "<TD align='left' class = 'LessTinyBlackB'>NUDOS</TD>";
echo "</TD>";
echo "</TR>";
echo "</TABLE>";
...
echo "<TABLE cellspacing = 1 cellpadding = 1>";
echo "<TR>";
echo "<TD align='left' class='SmallBlackB'>DIRECCION DEL VIENTO ${mediumpad}</TD>";
echo "<TD align='left' class='LessTinyBlackB'>(GRADOS)</TD>";
echo "</TR>";
echo "</TABLE>";
...
echo "<TR>";
echo "<TD align = 'left' width = '25%' class='SmallBlackB'>COMENTARIOS</TD>";
...
echo "<TABLE width = '100%'>";
echo "<TR>";
echo "<TD align = 'left' width = '25%' class='SmallBlackB'>OBSERVADOR</TD>";
...
echo "<TABLE width = '100%'>";
echo "<TR>";
echo "<TD align = 'left' width = '55%' class='SmallBlackB'>N<SUP>o</SUP> DE CAJAS DE MATRACES</TD>";
echo "<TD class = 'SmallBlackN'><HR NOSHADE SIZE = 1></FONT></TD>";
echo "</TR>";
echo "</TABLE>";
...
echo "</TD>";
echo "<TD align='center'>";
echo "<FONT class = 'SmallBlackB'>NO ESCRIBA EN ESTE CUANDRO</FONT>";
...
#
echo "<TR>";
echo "<TD align='left' class='SmallBlackB'>VOLTAJE DE BATERIA ${pad} (V)</TD>";
echo "</TR>";
#
#########################################
# Flow Rate
...
#
echo "<TR>";
echo "<TD align='left' class='SmallBlackB'>FLUJO DE AIRE ${pad} (LPM)</TD>";
echo "</TR>";
#
#########################################
# Pump Pressure
...
#
echo "<TR>";
echo "<TD align='left' class='SmallBlackB'>PRESI&Oacute;N DE LA BOMBA ${pad} LB/PULG<SUP>2</SUP> (PSI)</TD>";
echo "</TR>";
