...
<HTML>
 ...
 <BODY>
  <FORM action="upload_barcode_update_file.php" method="POST" enctype="multipart/form-data">
   <?PHP CreateMenu($database_object, $user_obj); ?>
   <TABLE border='1' cellspacing='5' cellpadding='5'>
    <TR>
     <TD colspan='2'>
      <H1>Update Cylinders from File</H1>
     </TD>
    </TR>
    <TR>
     <TD align='right'>
     ...
     <TD>
      ...
      <A href='example_update_file.txt'>Example file</A>
     </TD>
    </TR>
    <TR>
     <TD align='right'>
